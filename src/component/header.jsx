...
const Header = () => {
    ...
    //  simple function to to toggle the mobile menu 

    const toggle = () => {
        //  get mobile Menu
        const mobileMenu = document.getElementById("mobileMenu")

        //     if it has the 'hidden' 
    ...
    return (
        ...
        <header className='flex justify-between items-center py-4 px-4 lg:px-20' >
            ...
            <h1 data-aos="fade-down"
                ...
                data-aos-duration="1500" className='text-3xl md:text-4xl lg:text-5xl font-light m-0 ' > Ali Hassan</h1>
            ...
            {/* {Mobile Menu Button - visible only mobile on} */}
